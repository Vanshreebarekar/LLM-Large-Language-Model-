# -*- coding: utf-8 -*-
"""15_june_Prompt_project.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/19_g2F0f4yzzhHcR9-lA8VqU97IABoSwW
"""
...
# Using a high temperature
output = pipe(messages, do_sample=True, temperature=1.5)
print(output[0]["generated_text"])
...
# Using a low temperature
output = pipe(messages, do_sample=True, temperature=0.2)
print(output[0]["generated_text"])
...
# Using a high top_p
output = pipe(messages, do_sample=True, top_p=0.9)
print(output[0]["generated_text"])

# Using a high top_p
output = pipe(messages, do_sample=True, top_p=5)
print(output[0]["generated_text"])

# Using a tp_k
output = pipe(messages, do_sample=True, top_k=1)
print(output[0]["generated_text"])

# Using a tp_k
output = pipe(messages, do_sample=True, top_k=20)
print(output[0]["generated_text"])

# Using a tp_k
output = pipe(messages, do_sample=True, top_k=15)
print(output[0]["generated_text"])
...
one_shot_prompt = [
    {
        "role": "user",
        "content": "I think the food was alright"
    },
    {
        "role": "assistant",
        "content": "Neutral"
    ...
    {
        "role": "user",
        "content": "I think the food was good"
    }
]
print(tokenizer.apply_chat_template(one_shot_prompt, tokenize=False))
...
# Generate the output
outputs = pipe(one_shot_prompt)
print(outputs[0]["generated_text"])# Generate the output
outputs = pipe(one_shot_prompt)
print(outputs[0]["generated_text"])

# Create name and slogan for a product
product_prompt = [
    {"role": "user", "content": "Create a name and slogan for my new Generative AI Training Center"}
]
